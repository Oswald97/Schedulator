...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_3.setTitle(_translate("Dialog", "Pré visionnage"))
        self.cmbSection.setItemText(0, _translate("Dialog", "Classe 1"))
        self.cmbSection.setItemText(1, _translate("Dialog", "Classe 2"))
        self.cmbSection.setItemText(2, _translate("Dialog", "Classe 3"))
        self.cmbSection.setItemText(3, _translate("Dialog", "Classe 4"))
        self.cmbSection.setItemText(4, _translate("Dialog", "Classe 5"))
        self.chkPreview.setText(_translate("Dialog", "Désactiver Pré visio"))
        self.groupBox_4.setTitle(_translate("Dialog", "Operation"))
        self.btnPause.setText(_translate("Dialog", "Pause Generation"))
        self.btnStop.setText(_translate("Dialog", "Arreter Generation"))
        self.boxGen.setTitle(_translate("Dialog", "Generation N"))
        self.lblFitness.setText(_translate("Dialog", "Score Moyen:"))
        self.lblPreviousFitness.setText(_translate("Dialog", "Score Moyen Préccédent :"))
        self.lblPopulation.setText(_translate("Dialog", "Population:"))
        self.lblMutation.setText(_translate("Dialog", "Taux de Mutation:"))
        self.lblHighestFitness.setText(_translate("Dialog", "Meilleur Score:"))
        self.lblLowestFitness.setText(_translate("Dialog", "Faible Score:"))
        self.groupBox.setTitle(_translate("Dialog", "Info System"))
        self.lblCPU.setText(_translate("Dialog", "CPU Usage:"))
        self.lblTime.setText(_translate("Dialog", "Temps écoulé:"))
        self.lblMemory.setText(_translate("Dialog", "Usage Mémoire:"))
