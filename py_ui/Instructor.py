...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Enseignant"))
        self.lblName.setText(_translate("Dialog", "Nom"))
        self.lblHours.setText(_translate("Dialog", "Heures Disponible"))
        self.btnFinish.setText(_translate("Dialog", "Enregistrer"))
        self.btnCancel.setText(_translate("Dialog", "Annuler"))
