...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Plannificateur Automatique"))
        ...
        self.btnInstrAdd.setText(_translate("MainWindow", "Ajouter un Enseignant"))
        self.btnInstrImport.setText(_translate("MainWindow", "Importer depuis fichier CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "Enseignant"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Actions"))
        self.btnRoomAdd.setText(_translate("MainWindow", "Ajouter un Groupe pédagogique"))
        self.btnRoomImport.setText(_translate("MainWindow", "Importer depuis fichier CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "Salles"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Actions"))
        self.btnSubjAdd.setText(_translate("MainWindow", "Ajouter une Matiere"))
        self.btnSubjImport.setText(_translate("MainWindow", "Importer depuis fichier CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSubjects), _translate("MainWindow", "Matieres"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Actions"))
        self.btnSecAdd.setText(_translate("MainWindow", "Ajouter un Groupe pédagogique"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSections), _translate("MainWindow", "Groupe pédagogique"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Actions"))
        self.btnScenGenerate.setText(_translate("MainWindow", "Générer"))
        self.btnScenResult.setText(_translate("MainWindow", "Voir résultats"))
        self.groupBox_6.setTitle(_translate("MainWindow", "Paramètres Généraux de l'École"))
        self.radioLunchYes.setText(_translate("MainWindow", "Oui"))
        self.radioLunchNo.setText(_translate("MainWindow", "Non"))
        #self.label_6.setToolTip(_translate("MainWindow", "Assess for lunch break for sections."))
        self.label_6.setText(_translate("MainWindow", "Pause déjeuné"))
        #self.label_4.setToolTip(_translate("MainWindow", "Heure d'ouverture de l'École."))
        self.label_4.setText(_translate("MainWindow", "Heure démarrage des cours"))
        self.timeStarting.setDisplayFormat(_translate("MainWindow", "hh:mm"))
        #self.label_5.setToolTip(_translate("MainWindow", "Heure de fermetture de l'École."))
        self.label_5.setText(_translate("MainWindow", "Heure arrêt des cours"))
        self.timeEnding.setDisplayFormat(_translate("MainWindow", "hh:mm"))

        """self.groupBox_8.setTitle(_translate("MainWindow", "Paramètres de l'algorithme"))
        ...
        self.actionSettings.setText(_translate("MainWindow", "Paramètres"))
        self.actionExit.setText(_translate("MainWindow", "Quitter"))
        self.actionAdd_Instructor.setText(_translate("MainWindow", "Ajouter un Enseignant"))
        self.actionView_Instructors.setText(_translate("MainWindow", "Voir Enseignants"))
        self.actionAdd_Room.setText(_translate("MainWindow", "Ajouter une Salle"))
        self.actionView_Rooms.setText(_translate("MainWindow", "Voir Salles"))
        self.actionAdd_Subject.setText(_translate("MainWindow", "Ajouter Matiere"))
        self.actionView_Subjects.setText(_translate("MainWindow", "Voir Matieres"))
        self.actionAdd_Sections.setText(_translate("MainWindow", "Ajouter Groupe pédagogique"))
        self.actionView_Sections.setText(_translate("MainWindow", "Voir Groupe pédagogique"))
        self.actionImport.setText(_translate("MainWindow", "Importer"))
        self.actionExport.setText(_translate("MainWindow", "Exporter"))
        self.actionView_Results.setText(_translate("MainWindow", "Voir les résultats"))
        self.actionGenerate.setText(_translate("MainWindow", "Generer"))
        self.actionImport_2.setText(_translate("MainWindow", "Importer"))
        self.actionExport_2.setText(_translate("MainWindow", "Exporter"))
        self.actionScenario_Summary.setText(_translate("MainWindow", "Rapport Scenario"))
        self.actionGenerate_2.setText(_translate("MainWindow", "Generer"))
        self.actionView_Results_2.setText(_translate("MainWindow", "Voir les résultats"))
        self.actionInstructions.setText(_translate("MainWindow", "Enseignants"))
