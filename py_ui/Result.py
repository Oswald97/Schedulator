...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Visionneur de Résultats"))
        self.groupBox_3.setTitle(_translate("Dialog", "Solution"))
        self.cmbChromosome.setItemText(0, _translate("Dialog", "Solution 1"))
        self.cmbChromosome.setItemText(1, _translate("Dialog", "Solution 2"))
        self.cmbChromosome.setItemText(2, _translate("Dialog", "Solution 3"))
        self.cmbChromosome.setItemText(3, _translate("Dialog", "Solution 4"))
        self.cmbChromosome.setItemText(4, _translate("Dialog", "Solution 5"))
        self.groupBox.setTitle(_translate("Dialog", "Categorie"))
        self.cmbCategory.setItemText(0, _translate("Dialog", "Classes"))
        self.cmbCategory.setItemText(1, _translate("Dialog", "Salles"))
        self.cmbCategory.setItemText(2, _translate("Dialog", "Enseignant"))
        self.groupBox_2.setTitle(_translate("Dialog", "Entrée"))
        self.groupBox_6.setTitle(_translate("Dialog", "Actions"))
        self.btnExport.setText(_translate("Dialog", "Exporter le Resultat"))
        """self.groupBox_4.setTitle(_translate("Dialog", "Chromosome Details"))
        self.lblFit.setText(_translate("Dialog", "Score Total:"))
        ...
        self.lblLunch.setText(_translate("Dialog", "Pause:"))
        self.lblMeet.setText(_translate("Dialog", "Meeting Pattern: "))"""
        self.groupProblems.setTitle(_translate("Dialog", "Info System"))
        self.lblTime.setText(_translate("Dialog", "Generation Time:"))
        self.lblCPU.setText(_translate("Dialog", "Usage Moyen du CPU:"))
        self.lblMemory.setText(_translate("Dialog", "Usage Moyen de Mémoire:"))
