...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Matiere"))
        self.lblHours.setText(_translate("Dialog", "Heures/semaine"))
        self.lblName.setText(_translate("Dialog", "Nom"))
        self.groupBox_2.setTitle(_translate("Dialog", "Divisible"))
        self.radioYes.setText(_translate("Dialog", "Oui"))
        self.radioNo.setText(_translate("Dialog", "Non"))
        self.groupBox.setTitle(_translate("Dialog", "Type"))
        self.radioAny.setText(_translate("Dialog", "Importe"))
